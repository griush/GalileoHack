...
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacBDS_AlmanacSet_r12;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacECEF_SBAS_AlmanacSet;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacGLONASS_AlmanacSet;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacKeplerianSetV12;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacMidiAlmanacSet;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacNAV_KeplerianSet;
import com.google.location.custom_suplclient.asn1.supl2.lpp.AlmanacReducedKeplerianSet;
...
public  class GNSS_AlmanacElement extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $KeplerianAlmanacSet(Asn1Tag.fromClassAndNumber(2, 0),
      ...
      public Asn1Object createElement() {
        return new AlmanacKeplerianSetV12();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? AlmanacKeplerianSetV12.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public AlmanacKeplerianSetV12 getKeplerianAlmanacSet() {
    if (!isKeplerianAlmanacSet()) {
      throw new IllegalStateException("GNSS_AlmanacElement value not a KeplerianAlmanacSet");
    }
    return (AlmanacKeplerianSetV12) element;
  }

  public void setKeplerianAlmanacSet(AlmanacKeplerianSetV12 selected) {
    selection = Select.$KeplerianAlmanacSet;
    extension = false;
    element = selected;
  }

  public AlmanacKeplerianSetV12 setKeplerianAlmanacSetToNewInstance() {
      AlmanacKeplerianSetV12 element = new AlmanacKeplerianSetV12();
