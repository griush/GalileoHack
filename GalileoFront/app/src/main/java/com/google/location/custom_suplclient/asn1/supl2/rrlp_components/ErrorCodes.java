...
;
  ...
  public void setTo_missingComponet() {
    setValue(Value.missingComponet);
  }
  
  public void setTo_incorrectData() {
    setValue(Value.incorrectData);
  }
  
  public void setTo_missingIEorComponentElement() {
    setValue(Value.missingIEorComponentElement);
  }
  
  public void setTo_messageTooShort() {
    setValue(Value.messageTooShort);
  }
  
  public void setTo_unknowReferenceNumber() {
    setValue(Value.unknowReferenceNumber);
  }
