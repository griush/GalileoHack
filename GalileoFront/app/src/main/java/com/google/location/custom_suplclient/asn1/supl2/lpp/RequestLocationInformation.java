...
//
//
import com.google.location.custom_suplclient.asn1.base.Asn1Choice;
...
import com.google.location.custom_suplclient.asn1.base.ChoiceComponent;
...
* 
*/
public  class RequestLocationInformation extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_RequestLocationInformation
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public RequestLocationInformation() {
    super();
  }
  ...
  protected Asn1Tag getTag() {
    return TAG_RequestLocationInformation;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_RequestLocationInformation != null) {
      return ImmutableList.of(TAG_RequestLocationInformation);
    } else {
  ...
  /**
   * Creates a new RequestLocationInformation from encoded stream.
   */
  public static RequestLocationInformation fromPerUnaligned(byte[] encodedBytes) {
    RequestLocationInformation result = new RequestLocationInformation();
   ...
   * Creates a new RequestLocationInformation from encoded stream.
   */
  public static RequestLocationInformation fromPerAligned(byte[] encodedBytes) {
    RequestLocationInformation result = new RequestLocationInformation();
  ...
  private RequestLocationInformation.criticalExtensionsType criticalExtensions_;
  public RequestLocationInformation.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a RequestLocationInformation.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (RequestLocationInformation.criticalExtensionsType) value;
  }
  public RequestLocationInformation.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new RequestLocationInformation.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? RequestLocationInformation.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $RequestLocationInformation_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new RequestLocationInformation_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? RequestLocationInformation_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isRequestLocationInformation_r9() {
    return !hasExtensionValue() && Select.$RequestLocationInformation_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isRequestLocationInformation_r9}.
   */
  @SuppressWarnings("unchecked")
  public RequestLocationInformation_r9_IEs getRequestLocationInformation_r9() {
    if (!isRequestLocationInformation_r9()) {
      throw new IllegalStateException("c1Type value not a RequestLocationInformation_r9");
    }
    return (RequestLocationInformation_r9_IEs) element;
  }

  public void setRequestLocationInformation_r9(RequestLocationInformation_r9_IEs selected) {
    selection = Select.$RequestLocationInformation_r9;
    extension = false;
    element = selected;
  }

  public RequestLocationInformation_r9_IEs setRequestLocationInformation_r9ToNewInstance() {
      RequestLocationInformation_r9_IEs element = new RequestLocationInformation_r9_IEs();
      setRequestLocationInformation_r9(element);
      return element;
  }
...
public static class criticalExtensionsFutureType extends Asn1Sequence {
  ...
  public String toIndentedString(String indent) {
    StringBuilder builder = new StringBuilder();
    builder.append("RequestLocationInformation = {\n");
    final String internalIndent = indent + "  ";
    for (SequenceComponent component : getComponents()) {
      if (component.isExplicitlySet()) {
        builder.append(internalIndent)
