...
import com.google.location.custom_suplclient.asn1.supl2.lpp.GNSS_SystemTime;
import com.google.location.custom_suplclient.asn1.supl2.lpp_ver12.A_GNSS_ProvideAssistanceData;
import com.google.location.custom_suplclient.asn1.supl2.lpp_ver12.GNSS_GenericAssistData;
import com.google.location.custom_suplclient.asn1.supl2.lpp_ver12.GNSS_GenericAssistDataElement;
...
final class SuplLppClient extends SuplClient {
  ...
  protected SuplResponse suplPosToEphResponse(SUPLPOS message) {
    ...
    // Get the Ionospheric Model information
    List<GnssIonoModel> ionoModelList = new ArrayList<>();

    // Get Klobuchar Models available
    ionoModelList.add(SuplLppClientHelper.buildGnssIonoModel(
            assistData.getGnss_CommonAssistData().getGnss_IonosphericModel().getKlobucharModel()));

    // Get NeQuick Models available
    ionoModelList.add(SuplLppClientHelper.buildGnssIonoModel(
