...
* 
*/
public  class BT_LocationServerErrorCauses_r13 extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_BT_LocationServerErrorCauses_r13
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public BT_LocationServerErrorCauses_r13() {
    super();
  }
  ...
  protected Asn1Tag getTag() {
    return TAG_BT_LocationServerErrorCauses_r13;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_BT_LocationServerErrorCauses_r13 != null) {
      return ImmutableList.of(TAG_BT_LocationServerErrorCauses_r13);
    } else {
  ...
  /**
   * Creates a new BT_LocationServerErrorCauses_r13 from encoded stream.
   */
  public static BT_LocationServerErrorCauses_r13 fromPerUnaligned(byte[] encodedBytes) {
    BT_LocationServerErrorCauses_r13 result = new BT_LocationServerErrorCauses_r13();
   ...
   * Creates a new BT_LocationServerErrorCauses_r13 from encoded stream.
   */
  public static BT_LocationServerErrorCauses_r13 fromPerAligned(byte[] encodedBytes) {
    BT_LocationServerErrorCauses_r13 result = new BT_LocationServerErrorCauses_r13();
  ...
  private BT_LocationServerErrorCauses_r13.cause_r13Type cause_r13_;
  public BT_LocationServerErrorCauses_r13.cause_r13Type getCause_r13() {
    return cause_r13_;
  }
  /**
   * @throws ClassCastException if value is not a BT_LocationServerErrorCauses_r13.cause_r13Type
   */
  public void setCause_r13(Asn1Object value) {
    this.cause_r13_ = (BT_LocationServerErrorCauses_r13.cause_r13Type) value;
  }
  public BT_LocationServerErrorCauses_r13.cause_r13Type setCause_r13ToNewInstance() {
    cause_r13_ = new BT_LocationServerErrorCauses_r13.cause_r13Type();
    return cause_r13_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? BT_LocationServerErrorCauses_r13.cause_r13Type.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
;
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("BT_LocationServerErrorCauses_r13 = {\n");
