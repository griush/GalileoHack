...
public  class LocationError extends Asn1Sequence {
  ...
  private LocationFailureCause locationfailurecause_;
  public LocationFailureCause getLocationfailurecause() {
    return locationfailurecause_;
  }
  /**
   * @throws ClassCastException if value is not a LocationFailureCause
   */
  public void setLocationfailurecause(Asn1Object value) {
    this.locationfailurecause_ = (LocationFailureCause) value;
  }
  public LocationFailureCause setLocationfailurecauseToNewInstance() {
    locationfailurecause_ = new LocationFailureCause();
    return locationfailurecause_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public boolean isExplicitlySet() {
            return getLocationfailurecause() != null;
          }
          ...
          @Override public Asn1Object getComponentValue() {
            return getLocationfailurecause();
          }

          @Override public void setToNewInstance() {
            setLocationfailurecauseToNewInstance();
          }

          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? LocationFailureCause.getPossibleFirstTags() : ImmutableList.of(tag);
          }
          ...
          @Override public String toIndentedString(String indent) {
                return "locationfailurecause : "
                    + getLocationfailurecause().toIndentedString(indent);
              }
        });
