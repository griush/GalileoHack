...
;
  ...
  public void setTo_badArea() {
    setValue(Value.badArea);
  }
  
  public void setTo_notBadArea() {
    setValue(Value.notBadArea);
  }
  
  public void setTo_mixedArea() {
    setValue(Value.mixedArea);
  }
  ...
  private static final Asn1Tag TAG_Environment
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_Environment != null) {
      return ImmutableList.of(TAG_Environment);
    } else {
  ...
  /**
   * Creates a new Environment from encoded stream.
   */
  public static Environment fromPerUnaligned(byte[] encodedBytes) {
   ...
   * Creates a new Environment from encoded stream.
   */
  public static Environment fromPerAligned(byte[] encodedBytes) {
    Environment result = new Environment();
