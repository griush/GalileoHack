...
* 
*/
public  class RequestAssistanceData extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_RequestAssistanceData
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public RequestAssistanceData() {
    super();
  }
  ...
  protected Asn1Tag getTag() {
    return TAG_RequestAssistanceData;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_RequestAssistanceData != null) {
      return ImmutableList.of(TAG_RequestAssistanceData);
    } else {
  ...
  /**
   * Creates a new RequestAssistanceData from encoded stream.
   */
  public static RequestAssistanceData fromPerUnaligned(byte[] encodedBytes) {
    RequestAssistanceData result = new RequestAssistanceData();
   ...
   * Creates a new RequestAssistanceData from encoded stream.
   */
  public static RequestAssistanceData fromPerAligned(byte[] encodedBytes) {
    RequestAssistanceData result = new RequestAssistanceData();
  ...
  private RequestAssistanceData.criticalExtensionsType criticalExtensions_;
  public RequestAssistanceData.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a RequestAssistanceData.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (RequestAssistanceData.criticalExtensionsType) value;
  }
  public RequestAssistanceData.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new RequestAssistanceData.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? RequestAssistanceData.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $RequestAssistanceData_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new RequestAssistanceData_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? RequestAssistanceData_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isRequestAssistanceData_r9() {
    return !hasExtensionValue() && Select.$RequestAssistanceData_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isRequestAssistanceData_r9}.
   */
  @SuppressWarnings("unchecked")
  public RequestAssistanceData_r9_IEs getRequestAssistanceData_r9() {
    if (!isRequestAssistanceData_r9()) {
      throw new IllegalStateException("c1Type value not a RequestAssistanceData_r9");
    }
    return (RequestAssistanceData_r9_IEs) element;
  }

  public void setRequestAssistanceData_r9(RequestAssistanceData_r9_IEs selected) {
    selection = Select.$RequestAssistanceData_r9;
    extension = false;
    element = selected;
  }

  public RequestAssistanceData_r9_IEs setRequestAssistanceData_r9ToNewInstance() {
      RequestAssistanceData_r9_IEs element = new RequestAssistanceData_r9_IEs();
      setRequestAssistanceData_r9(element);
      return element;
  }
...
public static class criticalExtensionsFutureType extends Asn1Sequence {
  ...
  public String toIndentedString(String indent) {
    StringBuilder builder = new StringBuilder();
    builder.append("RequestAssistanceData = {\n");
    final String internalIndent = indent + "  ";
    for (SequenceComponent component : getComponents()) {
      if (component.isExplicitlySet()) {
        builder.append(internalIndent)
