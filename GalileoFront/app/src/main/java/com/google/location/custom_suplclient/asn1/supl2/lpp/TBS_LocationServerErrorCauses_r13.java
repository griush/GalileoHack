...
public  class TBS_LocationServerErrorCauses_r13 extends Asn1Sequence {
  ...
  private static final Asn1Tag TAG_TBS_LocationServerErrorCauses_r13
  ...
  protected Asn1Tag getTag() {
    return TAG_TBS_LocationServerErrorCauses_r13;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_TBS_LocationServerErrorCauses_r13 != null) {
      return ImmutableList.of(TAG_TBS_LocationServerErrorCauses_r13);
    } else {
  ...
  /**
   * Creates a new TBS_LocationServerErrorCauses_r13 from encoded stream.
   */
  public static TBS_LocationServerErrorCauses_r13 fromPerUnaligned(byte[] encodedBytes) {
    TBS_LocationServerErrorCauses_r13 result = new TBS_LocationServerErrorCauses_r13();
   ...
   * Creates a new TBS_LocationServerErrorCauses_r13 from encoded stream.
   */
  public static TBS_LocationServerErrorCauses_r13 fromPerAligned(byte[] encodedBytes) {
    TBS_LocationServerErrorCauses_r13 result = new TBS_LocationServerErrorCauses_r13();
  ...
  private TBS_LocationServerErrorCauses_r13.cause_r13Type cause_r13_;
  public TBS_LocationServerErrorCauses_r13.cause_r13Type getCause_r13() {
    return cause_r13_;
  }
  /**
   * @throws ClassCastException if value is not a TBS_LocationServerErrorCauses_r13.cause_r13Type
   */
  public void setCause_r13(Asn1Object value) {
    this.cause_r13_ = (TBS_LocationServerErrorCauses_r13.cause_r13Type) value;
  }
  public TBS_LocationServerErrorCauses_r13.cause_r13Type setCause_r13ToNewInstance() {
    cause_r13_ = new TBS_LocationServerErrorCauses_r13.cause_r13Type();
    return cause_r13_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? TBS_LocationServerErrorCauses_r13.cause_r13Type.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
;
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("TBS_LocationServerErrorCauses_r13 = {\n");
