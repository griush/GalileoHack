 ...
 * 
 */
public  class TBS_Error_r13 extends Asn1Choice {
  //

  private static final Asn1Tag TAG_TBS_Error_r13
      ...
      for (Asn1Tag tag : select.getPossibleFirstTags()) {
        ...
        if ((select0 = tagToSelection.put(tag, select)) != null) {
          throw new IllegalStateException(
            "TBS_Error_r13: " + tag + " maps to both " + select0 + " and " + select);
        }
      }
    }
  }

  public TBS_Error_r13() {
    super();
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_TBS_Error_r13 != null) {
      return ImmutableList.of(TAG_TBS_Error_r13);
    } else {
  ...
  /**
   * Creates a new TBS_Error_r13 from encoded stream.
   */
  public static TBS_Error_r13 fromPerUnaligned(byte[] encodedBytes) {
    TBS_Error_r13 result = new TBS_Error_r13();
   ...
   * Creates a new TBS_Error_r13 from encoded stream.
   */
  public static TBS_Error_r13 fromPerAligned(byte[] encodedBytes) {
    TBS_Error_r13 result = new TBS_Error_r13();
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $LocationServerErrorCauses_r13(Asn1Tag.fromClassAndNumber(2, 0),
      ...
      public Asn1Object createElement() {
        return new TBS_LocationServerErrorCauses_r13();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? TBS_LocationServerErrorCauses_r13.getPossibleFirstTags() : ImmutableList.of(tag);
      }
    ...
    $TargetDeviceErrorCauses_r13(Asn1Tag.fromClassAndNumber(2, 1),
      ...
      @Override
      public Asn1Object createElement() {
        return new TBS_TargetDeviceErrorCauses_r13();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? TBS_TargetDeviceErrorCauses_r13.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public TBS_LocationServerErrorCauses_r13 getLocationServerErrorCauses_r13() {
    if (!isLocationServerErrorCauses_r13()) {
      throw new IllegalStateException("TBS_Error_r13 value not a LocationServerErrorCauses_r13");
    }
    return (TBS_LocationServerErrorCauses_r13) element;
  }

  public void setLocationServerErrorCauses_r13(TBS_LocationServerErrorCauses_r13 selected) {
    selection = Select.$LocationServerErrorCauses_r13;
    extension = false;
    element = selected;
  }

  public TBS_LocationServerErrorCauses_r13 setLocationServerErrorCauses_r13ToNewInstance() {
      TBS_LocationServerErrorCauses_r13 element = new TBS_LocationServerErrorCauses_r13();
   ...
   */
  @SuppressWarnings("unchecked")
  public TBS_TargetDeviceErrorCauses_r13 getTargetDeviceErrorCauses_r13() {
    if (!isTargetDeviceErrorCauses_r13()) {
      throw new IllegalStateException("TBS_Error_r13 value not a TargetDeviceErrorCauses_r13");
    }
    return (TBS_TargetDeviceErrorCauses_r13) element;
  }

  public void setTargetDeviceErrorCauses_r13(TBS_TargetDeviceErrorCauses_r13 selected) {
    selection = Select.$TargetDeviceErrorCauses_r13;
    extension = false;
    element = selected;
  }

  public TBS_TargetDeviceErrorCauses_r13 setTargetDeviceErrorCauses_r13ToNewInstance() {
      TBS_TargetDeviceErrorCauses_r13 element = new TBS_TargetDeviceErrorCauses_r13();
  ...
  public String toIndentedString(String indent) {
    return "TBS_Error_r13 = " + elementIndentedString(indent) + indent + ";\n";
  }
}
