 ...
 * 
 */
public  class OTDOA_Error extends Asn1Choice {
  //

  private static final Asn1Tag TAG_OTDOA_Error
      ...
      for (Asn1Tag tag : select.getPossibleFirstTags()) {
        ...
        if ((select0 = tagToSelection.put(tag, select)) != null) {
          throw new IllegalStateException(
            "OTDOA_Error: " + tag + " maps to both " + select0 + " and " + select);
        }
      }
    }
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_OTDOA_Error != null) {
      return ImmutableList.of(TAG_OTDOA_Error);
    } else {
  ...
  /**
   * Creates a new OTDOA_Error from encoded stream.
   */
  public static OTDOA_Error fromPerUnaligned(byte[] encodedBytes) {
    OTDOA_Error result = new OTDOA_Error();
   ...
   * Creates a new OTDOA_Error from encoded stream.
   */
  public static OTDOA_Error fromPerAligned(byte[] encodedBytes) {
    OTDOA_Error result = new OTDOA_Error();
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $LocationServerErrorCauses(Asn1Tag.fromClassAndNumber(2, 0),
      ...
      public Asn1Object createElement() {
        return new OTDOA_LocationServerErrorCauses();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? OTDOA_LocationServerErrorCauses.getPossibleFirstTags() : ImmutableList.of(tag);
      }
    ...
    $TargetDeviceErrorCauses(Asn1Tag.fromClassAndNumber(2, 1),
      ...
      @Override
      public Asn1Object createElement() {
        return new OTDOA_TargetDeviceErrorCauses();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? OTDOA_TargetDeviceErrorCauses.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public OTDOA_LocationServerErrorCauses getLocationServerErrorCauses() {
    if (!isLocationServerErrorCauses()) {
      throw new IllegalStateException("OTDOA_Error value not a LocationServerErrorCauses");
    }
    return (OTDOA_LocationServerErrorCauses) element;
  }

  public void setLocationServerErrorCauses(OTDOA_LocationServerErrorCauses selected) {
    selection = Select.$LocationServerErrorCauses;
    extension = false;
    element = selected;
  }

  public OTDOA_LocationServerErrorCauses setLocationServerErrorCausesToNewInstance() {
      OTDOA_LocationServerErrorCauses element = new OTDOA_LocationServerErrorCauses();
   ...
   */
  @SuppressWarnings("unchecked")
  public OTDOA_TargetDeviceErrorCauses getTargetDeviceErrorCauses() {
    if (!isTargetDeviceErrorCauses()) {
      throw new IllegalStateException("OTDOA_Error value not a TargetDeviceErrorCauses");
    }
    return (OTDOA_TargetDeviceErrorCauses) element;
  }

  public void setTargetDeviceErrorCauses(OTDOA_TargetDeviceErrorCauses selected) {
    selection = Select.$TargetDeviceErrorCauses;
    extension = false;
    element = selected;
  }

  public OTDOA_TargetDeviceErrorCauses setTargetDeviceErrorCausesToNewInstance() {
      OTDOA_TargetDeviceErrorCauses element = new OTDOA_TargetDeviceErrorCauses();
  ...
  public String toIndentedString(String indent) {
    return "OTDOA_Error = " + elementIndentedString(indent) + indent + ";\n";
  }
}
