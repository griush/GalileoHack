...
* 
*/
public  class ProvideCapabilities extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_ProvideCapabilities
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public ProvideCapabilities() {
    super();
  }
  ...
  protected Asn1Tag getTag() {
    return TAG_ProvideCapabilities;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_ProvideCapabilities != null) {
      return ImmutableList.of(TAG_ProvideCapabilities);
    } else {
  ...
  /**
   * Creates a new ProvideCapabilities from encoded stream.
   */
  public static ProvideCapabilities fromPerUnaligned(byte[] encodedBytes) {
    ProvideCapabilities result = new ProvideCapabilities();
   ...
   * Creates a new ProvideCapabilities from encoded stream.
   */
  public static ProvideCapabilities fromPerAligned(byte[] encodedBytes) {
    ProvideCapabilities result = new ProvideCapabilities();
  ...
  private ProvideCapabilities.criticalExtensionsType criticalExtensions_;
  public ProvideCapabilities.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a ProvideCapabilities.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (ProvideCapabilities.criticalExtensionsType) value;
  }
  public ProvideCapabilities.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new ProvideCapabilities.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? ProvideCapabilities.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $ProvideCapabilities_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new ProvideCapabilities_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? ProvideCapabilities_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isProvideCapabilities_r9() {
    return !hasExtensionValue() && Select.$ProvideCapabilities_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isProvideCapabilities_r9}.
   */
  @SuppressWarnings("unchecked")
  public ProvideCapabilities_r9_IEs getProvideCapabilities_r9() {
    if (!isProvideCapabilities_r9()) {
      throw new IllegalStateException("c1Type value not a ProvideCapabilities_r9");
    }
    return (ProvideCapabilities_r9_IEs) element;
  }

  public void setProvideCapabilities_r9(ProvideCapabilities_r9_IEs selected) {
    selection = Select.$ProvideCapabilities_r9;
    extension = false;
    element = selected;
  }

  public ProvideCapabilities_r9_IEs setProvideCapabilities_r9ToNewInstance() {
      ProvideCapabilities_r9_IEs element = new ProvideCapabilities_r9_IEs();
      setProvideCapabilities_r9(element);
      return element;
  }
...
public static class criticalExtensionsFutureType extends Asn1Sequence {
  ...
  public String toIndentedString(String indent) {
    StringBuilder builder = new StringBuilder();
    builder.append("ProvideCapabilities = {\n");
    final String internalIndent = indent + "  ";
    for (SequenceComponent component : getComponents()) {
      if (component.isExplicitlySet()) {
        builder.append(internalIndent)
