...
* 
*/
public  class GNSS_AlmanacReq extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_GNSS_AlmanacReq
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_GNSS_AlmanacReq != null) {
      return ImmutableList.of(TAG_GNSS_AlmanacReq);
    } else {
  ...
  /**
   * Creates a new GNSS_AlmanacReq from encoded stream.
   */
  public static GNSS_AlmanacReq fromPerUnaligned(byte[] encodedBytes) {
    GNSS_AlmanacReq result = new GNSS_AlmanacReq();
   ...
   * Creates a new GNSS_AlmanacReq from encoded stream.
   */
  public static GNSS_AlmanacReq fromPerAligned(byte[] encodedBytes) {
    GNSS_AlmanacReq result = new GNSS_AlmanacReq();
  ...
  private GNSS_AlmanacReq.modelIDType modelID_;
  public GNSS_AlmanacReq.modelIDType getModelID() {
    return modelID_;
  }
  /**
   * @throws ClassCastException if value is not a GNSS_AlmanacReq.modelIDType
   */
  public void setModelID(Asn1Object value) {
    this.modelID_ = (GNSS_AlmanacReq.modelIDType) value;
  }
  public GNSS_AlmanacReq.modelIDType setModelIDToNewInstance() {
    modelID_ = new GNSS_AlmanacReq.modelIDType();
    return modelID_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? GNSS_AlmanacReq.modelIDType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class modelIDType extends Asn1Integer {
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("GNSS_AlmanacReq = {\n");
