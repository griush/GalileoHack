...
* 
*/
public  class VerticalAccuracy extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_VerticalAccuracy
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_VerticalAccuracy != null) {
      return ImmutableList.of(TAG_VerticalAccuracy);
    } else {
  ...
  /**
   * Creates a new VerticalAccuracy from encoded stream.
   */
  public static VerticalAccuracy fromPerUnaligned(byte[] encodedBytes) {
    VerticalAccuracy result = new VerticalAccuracy();
   ...
   * Creates a new VerticalAccuracy from encoded stream.
   */
  public static VerticalAccuracy fromPerAligned(byte[] encodedBytes) {
    VerticalAccuracy result = new VerticalAccuracy();
  ...
  private VerticalAccuracy.accuracyType accuracy_;
  public VerticalAccuracy.accuracyType getAccuracy() {
    return accuracy_;
  }
  /**
   * @throws ClassCastException if value is not a VerticalAccuracy.accuracyType
   */
  public void setAccuracy(Asn1Object value) {
    this.accuracy_ = (VerticalAccuracy.accuracyType) value;
  }
  public VerticalAccuracy.accuracyType setAccuracyToNewInstance() {
    accuracy_ = new VerticalAccuracy.accuracyType();
    return accuracy_;
  }
  
  private VerticalAccuracy.confidenceType confidence_;
  public VerticalAccuracy.confidenceType getConfidence() {
    return confidence_;
  }
  /**
   * @throws ClassCastException if value is not a VerticalAccuracy.confidenceType
   */
  public void setConfidence(Asn1Object value) {
    this.confidence_ = (VerticalAccuracy.confidenceType) value;
  }
  public VerticalAccuracy.confidenceType setConfidenceToNewInstance() {
    confidence_ = new VerticalAccuracy.confidenceType();
    return confidence_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? VerticalAccuracy.accuracyType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? VerticalAccuracy.confidenceType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class confidenceType extends Asn1Integer {
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("VerticalAccuracy = {\n");
