...
* 
*/
public  class UTC_ModelSet4 extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_UTC_ModelSet4
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_UTC_ModelSet4 != null) {
      return ImmutableList.of(TAG_UTC_ModelSet4);
    } else {
  ...
  /**
   * Creates a new UTC_ModelSet4 from encoded stream.
   */
  public static UTC_ModelSet4 fromPerUnaligned(byte[] encodedBytes) {
    UTC_ModelSet4 result = new UTC_ModelSet4();
   ...
   * Creates a new UTC_ModelSet4 from encoded stream.
   */
  public static UTC_ModelSet4 fromPerAligned(byte[] encodedBytes) {
    UTC_ModelSet4 result = new UTC_ModelSet4();
  ...
  private UTC_ModelSet4.utcA1wntType utcA1wnt_;
  public UTC_ModelSet4.utcA1wntType getUtcA1wnt() {
    return utcA1wnt_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcA1wntType
   */
  public void setUtcA1wnt(Asn1Object value) {
    this.utcA1wnt_ = (UTC_ModelSet4.utcA1wntType) value;
  }
  public UTC_ModelSet4.utcA1wntType setUtcA1wntToNewInstance() {
    utcA1wnt_ = new UTC_ModelSet4.utcA1wntType();
    return utcA1wnt_;
  }
  
  private UTC_ModelSet4.utcA0wntType utcA0wnt_;
  public UTC_ModelSet4.utcA0wntType getUtcA0wnt() {
    return utcA0wnt_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcA0wntType
   */
  public void setUtcA0wnt(Asn1Object value) {
    this.utcA0wnt_ = (UTC_ModelSet4.utcA0wntType) value;
  }
  public UTC_ModelSet4.utcA0wntType setUtcA0wntToNewInstance() {
    utcA0wnt_ = new UTC_ModelSet4.utcA0wntType();
    return utcA0wnt_;
  }
  
  private UTC_ModelSet4.utcTotType utcTot_;
  public UTC_ModelSet4.utcTotType getUtcTot() {
    return utcTot_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcTotType
   */
  public void setUtcTot(Asn1Object value) {
    this.utcTot_ = (UTC_ModelSet4.utcTotType) value;
  }
  public UTC_ModelSet4.utcTotType setUtcTotToNewInstance() {
    utcTot_ = new UTC_ModelSet4.utcTotType();
    return utcTot_;
  }
  
  private UTC_ModelSet4.utcWNtType utcWNt_;
  public UTC_ModelSet4.utcWNtType getUtcWNt() {
    return utcWNt_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcWNtType
   */
  public void setUtcWNt(Asn1Object value) {
    this.utcWNt_ = (UTC_ModelSet4.utcWNtType) value;
  }
  public UTC_ModelSet4.utcWNtType setUtcWNtToNewInstance() {
    utcWNt_ = new UTC_ModelSet4.utcWNtType();
    return utcWNt_;
  }
  
  private UTC_ModelSet4.utcDeltaTlsType utcDeltaTls_;
  public UTC_ModelSet4.utcDeltaTlsType getUtcDeltaTls() {
    return utcDeltaTls_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcDeltaTlsType
   */
  public void setUtcDeltaTls(Asn1Object value) {
    this.utcDeltaTls_ = (UTC_ModelSet4.utcDeltaTlsType) value;
  }
  public UTC_ModelSet4.utcDeltaTlsType setUtcDeltaTlsToNewInstance() {
    utcDeltaTls_ = new UTC_ModelSet4.utcDeltaTlsType();
    return utcDeltaTls_;
  }
  
  private UTC_ModelSet4.utcWNlsfType utcWNlsf_;
  public UTC_ModelSet4.utcWNlsfType getUtcWNlsf() {
    return utcWNlsf_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcWNlsfType
   */
  public void setUtcWNlsf(Asn1Object value) {
    this.utcWNlsf_ = (UTC_ModelSet4.utcWNlsfType) value;
  }
  public UTC_ModelSet4.utcWNlsfType setUtcWNlsfToNewInstance() {
    utcWNlsf_ = new UTC_ModelSet4.utcWNlsfType();
    return utcWNlsf_;
  }
  
  private UTC_ModelSet4.utcDNType utcDN_;
  public UTC_ModelSet4.utcDNType getUtcDN() {
    return utcDN_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcDNType
   */
  public void setUtcDN(Asn1Object value) {
    this.utcDN_ = (UTC_ModelSet4.utcDNType) value;
  }
  public UTC_ModelSet4.utcDNType setUtcDNToNewInstance() {
    utcDN_ = new UTC_ModelSet4.utcDNType();
    return utcDN_;
  }
  
  private UTC_ModelSet4.utcDeltaTlsfType utcDeltaTlsf_;
  public UTC_ModelSet4.utcDeltaTlsfType getUtcDeltaTlsf() {
    return utcDeltaTlsf_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcDeltaTlsfType
   */
  public void setUtcDeltaTlsf(Asn1Object value) {
    this.utcDeltaTlsf_ = (UTC_ModelSet4.utcDeltaTlsfType) value;
  }
  public UTC_ModelSet4.utcDeltaTlsfType setUtcDeltaTlsfToNewInstance() {
    utcDeltaTlsf_ = new UTC_ModelSet4.utcDeltaTlsfType();
    return utcDeltaTlsf_;
  }
  
  private UTC_ModelSet4.utcStandardIDType utcStandardID_;
  public UTC_ModelSet4.utcStandardIDType getUtcStandardID() {
    return utcStandardID_;
  }
  /**
   * @throws ClassCastException if value is not a UTC_ModelSet4.utcStandardIDType
   */
  public void setUtcStandardID(Asn1Object value) {
    this.utcStandardID_ = (UTC_ModelSet4.utcStandardIDType) value;
  }
  public UTC_ModelSet4.utcStandardIDType setUtcStandardIDToNewInstance() {
    utcStandardID_ = new UTC_ModelSet4.utcStandardIDType();
    return utcStandardID_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcA1wntType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcA0wntType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcTotType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcWNtType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcDeltaTlsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcWNlsfType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcDNType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcDeltaTlsfType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? UTC_ModelSet4.utcStandardIDType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
