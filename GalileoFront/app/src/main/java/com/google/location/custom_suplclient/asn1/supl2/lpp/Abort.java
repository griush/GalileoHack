...
* 
*/
public  class Abort extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_Abort
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_Abort != null) {
      return ImmutableList.of(TAG_Abort);
    } else {
  ...
  /**
   * Creates a new Abort from encoded stream.
   */
  public static Abort fromPerUnaligned(byte[] encodedBytes) {
    Abort result = new Abort();
   ...
   * Creates a new Abort from encoded stream.
   */
  public static Abort fromPerAligned(byte[] encodedBytes) {
    Abort result = new Abort();
  ...
  private Abort.criticalExtensionsType criticalExtensions_;
  public Abort.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a Abort.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (Abort.criticalExtensionsType) value;
  }
  public Abort.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new Abort.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? Abort.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $Abort_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new Abort_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? Abort_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isAbort_r9() {
    return !hasExtensionValue() && Select.$Abort_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isAbort_r9}.
   */
  @SuppressWarnings("unchecked")
  public Abort_r9_IEs getAbort_r9() {
    if (!isAbort_r9()) {
      throw new IllegalStateException("c1Type value not a Abort_r9");
    }
    return (Abort_r9_IEs) element;
  }

  public void setAbort_r9(Abort_r9_IEs selected) {
    selection = Select.$Abort_r9;
    extension = false;
    element = selected;
  }

  public Abort_r9_IEs setAbort_r9ToNewInstance() {
      Abort_r9_IEs element = new Abort_r9_IEs();
      setAbort_r9(element);
      return element;
  }
