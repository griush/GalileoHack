...
package com.google.location.custom_suplclient.asn1.supl2.lpp_ver12;
...
public  class ProvideAssistanceData extends Asn1Sequence {
  ...
  private static final Asn1Tag TAG_ProvideAssistanceData
  ...
  protected Asn1Tag getTag() {
    return TAG_ProvideAssistanceData;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_ProvideAssistanceData != null) {
      return ImmutableList.of(TAG_ProvideAssistanceData);
    } else {
  ...
  /**
   * Creates a new ProvideAssistanceData from encoded stream.
   */
  public static ProvideAssistanceData fromPerUnaligned(byte[] encodedBytes) {
    ProvideAssistanceData result = new ProvideAssistanceData();
   ...
   * Creates a new ProvideAssistanceData from encoded stream.
   */
  public static ProvideAssistanceData fromPerAligned(byte[] encodedBytes) {
    ProvideAssistanceData result = new ProvideAssistanceData();
  ...
  private ProvideAssistanceData.criticalExtensionsType criticalExtensions_;
  public ProvideAssistanceData.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a ProvideAssistanceData.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (ProvideAssistanceData.criticalExtensionsType) value;
  }
  public ProvideAssistanceData.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new ProvideAssistanceData.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? ProvideAssistanceData.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $ProvideAssistanceData_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new ProvideAssistanceData_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? ProvideAssistanceData_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isProvideAssistanceData_r9() {
    return !hasExtensionValue() && Select.$ProvideAssistanceData_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isProvideAssistanceData_r9}.
   */
  @SuppressWarnings("unchecked")
  public ProvideAssistanceData_r9_IEs getProvideAssistanceData_r9() {
    if (!isProvideAssistanceData_r9()) {
      throw new IllegalStateException("c1Type value not a ProvideAssistanceData_r9");
    }
    return (ProvideAssistanceData_r9_IEs) element;
  }

  public void setProvideAssistanceData_r9(ProvideAssistanceData_r9_IEs selected) {
    selection = Select.$ProvideAssistanceData_r9;
    extension = false;
    element = selected;
  }

  public ProvideAssistanceData_r9_IEs setProvideAssistanceData_r9ToNewInstance() {
      ProvideAssistanceData_r9_IEs element = new ProvideAssistanceData_r9_IEs();
      setProvideAssistanceData_r9(element);
      return element;
  }
...
public static class criticalExtensionsFutureType extends Asn1Sequence {
  ...
  public String toIndentedString(String indent) {
    StringBuilder builder = new StringBuilder();
    builder.append("ProvideAssistanceData = {\n");
    final String internalIndent = indent + "  ";
    for (SequenceComponent component : getComponents()) {
      if (component.isExplicitlySet()) {
        builder.append(internalIndent)
