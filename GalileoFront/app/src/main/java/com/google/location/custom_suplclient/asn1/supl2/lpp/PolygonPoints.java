...
* 
*/
public  class PolygonPoints extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_PolygonPoints
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_PolygonPoints != null) {
      return ImmutableList.of(TAG_PolygonPoints);
    } else {
  ...
  /**
   * Creates a new PolygonPoints from encoded stream.
   */
  public static PolygonPoints fromPerUnaligned(byte[] encodedBytes) {
    PolygonPoints result = new PolygonPoints();
   ...
   * Creates a new PolygonPoints from encoded stream.
   */
  public static PolygonPoints fromPerAligned(byte[] encodedBytes) {
    PolygonPoints result = new PolygonPoints();
  ...
  private PolygonPoints.latitudeSignType latitudeSign_;
  public PolygonPoints.latitudeSignType getLatitudeSign() {
    return latitudeSign_;
  }
  /**
   * @throws ClassCastException if value is not a PolygonPoints.latitudeSignType
   */
  public void setLatitudeSign(Asn1Object value) {
    this.latitudeSign_ = (PolygonPoints.latitudeSignType) value;
  }
  public PolygonPoints.latitudeSignType setLatitudeSignToNewInstance() {
    latitudeSign_ = new PolygonPoints.latitudeSignType();
    return latitudeSign_;
  }
  
  private PolygonPoints.degreesLatitudeType degreesLatitude_;
  public PolygonPoints.degreesLatitudeType getDegreesLatitude() {
    return degreesLatitude_;
  }
  /**
   * @throws ClassCastException if value is not a PolygonPoints.degreesLatitudeType
   */
  public void setDegreesLatitude(Asn1Object value) {
    this.degreesLatitude_ = (PolygonPoints.degreesLatitudeType) value;
  }
  public PolygonPoints.degreesLatitudeType setDegreesLatitudeToNewInstance() {
    degreesLatitude_ = new PolygonPoints.degreesLatitudeType();
    return degreesLatitude_;
  }
  
  private PolygonPoints.degreesLongitudeType degreesLongitude_;
  public PolygonPoints.degreesLongitudeType getDegreesLongitude() {
    return degreesLongitude_;
  }
  /**
   * @throws ClassCastException if value is not a PolygonPoints.degreesLongitudeType
   */
  public void setDegreesLongitude(Asn1Object value) {
    this.degreesLongitude_ = (PolygonPoints.degreesLongitudeType) value;
  }
  public PolygonPoints.degreesLongitudeType setDegreesLongitudeToNewInstance() {
    degreesLongitude_ = new PolygonPoints.degreesLongitudeType();
    return degreesLongitude_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? PolygonPoints.latitudeSignType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? PolygonPoints.degreesLatitudeType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? PolygonPoints.degreesLongitudeType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
