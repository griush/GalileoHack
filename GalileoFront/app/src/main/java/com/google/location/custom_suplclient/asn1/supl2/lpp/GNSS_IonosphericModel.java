...
public  class GNSS_IonosphericModel extends Asn1Sequence {
  ...
  private NeQuickModelParameter neQuickModel_;
  public NeQuickModelParameter getNeQuickModel() {
    return neQuickModel_;
  }
  /**
   * @throws ClassCastException if value is not a NeQuickModelParameter
   */
  public void setNeQuickModel(Asn1Object value) {
    this.neQuickModel_ = (NeQuickModelParameter) value;
  }
  public NeQuickModelParameter setNeQuickModelToNewInstance() {
    neQuickModel_ = new NeQuickModelParameter();
    return neQuickModel_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? NeQuickModelParameter.getPossibleFirstTags() : ImmutableList.of(tag);
          }
