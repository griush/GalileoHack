...
* 
*/
public  class GNSS_DataBitsReqSatElement extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_GNSS_DataBitsReqSatElement
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public GNSS_DataBitsReqSatElement() {
    super();
  }
  ...
  protected Asn1Tag getTag() {
    return TAG_GNSS_DataBitsReqSatElement;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_GNSS_DataBitsReqSatElement != null) {
      return ImmutableList.of(TAG_GNSS_DataBitsReqSatElement);
    } else {
  ...
  /**
   * Creates a new GNSS_DataBitsReqSatElement from encoded stream.
   */
  public static GNSS_DataBitsReqSatElement fromPerUnaligned(byte[] encodedBytes) {
    GNSS_DataBitsReqSatElement result = new GNSS_DataBitsReqSatElement();
   ...
   * Creates a new GNSS_DataBitsReqSatElement from encoded stream.
   */
  public static GNSS_DataBitsReqSatElement fromPerAligned(byte[] encodedBytes) {
    GNSS_DataBitsReqSatElement result = new GNSS_DataBitsReqSatElement();
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("GNSS_DataBitsReqSatElement = {\n");
