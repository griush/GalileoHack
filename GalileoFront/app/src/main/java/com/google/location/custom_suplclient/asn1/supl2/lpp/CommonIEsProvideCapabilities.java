...
* 
*/
public  class CommonIEsProvideCapabilities extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_CommonIEsProvideCapabilities
  ...
  protected Asn1Tag getTag() {
    return TAG_CommonIEsProvideCapabilities;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_CommonIEsProvideCapabilities != null) {
      return ImmutableList.of(TAG_CommonIEsProvideCapabilities);
    } else {
   ...
   * Creates a new CommonIEsProvideCapabilities from encoded stream.
   */
  public static CommonIEsProvideCapabilities fromPerAligned(byte[] encodedBytes) {
    CommonIEsProvideCapabilities result = new CommonIEsProvideCapabilities();
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("CommonIEsProvideCapabilities = {\n");
