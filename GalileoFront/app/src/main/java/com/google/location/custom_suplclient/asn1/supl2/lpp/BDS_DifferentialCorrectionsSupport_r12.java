...
* 
*/
public  class BDS_DifferentialCorrectionsSupport_r12 extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_BDS_DifferentialCorrectionsSupport_r12
  ...
  protected Asn1Tag getTag() {
    return TAG_BDS_DifferentialCorrectionsSupport_r12;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_BDS_DifferentialCorrectionsSupport_r12 != null) {
      return ImmutableList.of(TAG_BDS_DifferentialCorrectionsSupport_r12);
    } else {
  ...
  /**
   * Creates a new BDS_DifferentialCorrectionsSupport_r12 from encoded stream.
   */
  public static BDS_DifferentialCorrectionsSupport_r12 fromPerUnaligned(byte[] encodedBytes) {
    BDS_DifferentialCorrectionsSupport_r12 result = new BDS_DifferentialCorrectionsSupport_r12();
   ...
   * Creates a new BDS_DifferentialCorrectionsSupport_r12 from encoded stream.
   */
  public static BDS_DifferentialCorrectionsSupport_r12 fromPerAligned(byte[] encodedBytes) {
    BDS_DifferentialCorrectionsSupport_r12 result = new BDS_DifferentialCorrectionsSupport_r12();
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("BDS_DifferentialCorrectionsSupport_r12 = {\n");
