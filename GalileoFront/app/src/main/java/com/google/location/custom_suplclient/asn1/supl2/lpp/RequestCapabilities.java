...
* 
*/
public  class RequestCapabilities extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_RequestCapabilities
  ...
  protected Asn1Tag getTag() {
    return TAG_RequestCapabilities;
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_RequestCapabilities != null) {
      return ImmutableList.of(TAG_RequestCapabilities);
    } else {
  ...
  /**
   * Creates a new RequestCapabilities from encoded stream.
   */
  public static RequestCapabilities fromPerUnaligned(byte[] encodedBytes) {
    RequestCapabilities result = new RequestCapabilities();
   ...
   * Creates a new RequestCapabilities from encoded stream.
   */
  public static RequestCapabilities fromPerAligned(byte[] encodedBytes) {
    RequestCapabilities result = new RequestCapabilities();
  ...
  private RequestCapabilities.criticalExtensionsType criticalExtensions_;
  public RequestCapabilities.criticalExtensionsType getCriticalExtensions() {
    return criticalExtensions_;
  }
  /**
   * @throws ClassCastException if value is not a RequestCapabilities.criticalExtensionsType
   */
  public void setCriticalExtensions(Asn1Object value) {
    this.criticalExtensions_ = (RequestCapabilities.criticalExtensionsType) value;
  }
  public RequestCapabilities.criticalExtensionsType setCriticalExtensionsToNewInstance() {
    criticalExtensions_ = new RequestCapabilities.criticalExtensionsType();
    return criticalExtensions_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? RequestCapabilities.criticalExtensionsType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class c1Type extends Asn1Choice {
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $RequestCapabilities_r9(Asn1Tag.fromClassAndNumber(2, 0),
        true) {
      @Override
      public Asn1Object createElement() {
        return new RequestCapabilities_r9_IEs();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? RequestCapabilities_r9_IEs.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public boolean isRequestCapabilities_r9() {
    return !hasExtensionValue() && Select.$RequestCapabilities_r9 == selection;
  }

  /**
   * @throws {@code IllegalStateException} if {@code !isRequestCapabilities_r9}.
   */
  @SuppressWarnings("unchecked")
  public RequestCapabilities_r9_IEs getRequestCapabilities_r9() {
    if (!isRequestCapabilities_r9()) {
      throw new IllegalStateException("c1Type value not a RequestCapabilities_r9");
    }
    return (RequestCapabilities_r9_IEs) element;
  }

  public void setRequestCapabilities_r9(RequestCapabilities_r9_IEs selected) {
    selection = Select.$RequestCapabilities_r9;
    extension = false;
    element = selected;
  }

  public RequestCapabilities_r9_IEs setRequestCapabilities_r9ToNewInstance() {
      RequestCapabilities_r9_IEs element = new RequestCapabilities_r9_IEs();
      setRequestCapabilities_r9(element);
      return element;
  }
...
public static class criticalExtensionsFutureType extends Asn1Sequence {
  ...
  public String toIndentedString(String indent) {
    StringBuilder builder = new StringBuilder();
    builder.append("RequestCapabilities = {\n");
    final String internalIndent = indent + "  ";
    for (SequenceComponent component : getComponents()) {
      if (component.isExplicitlySet()) {
        builder.append(internalIndent)
