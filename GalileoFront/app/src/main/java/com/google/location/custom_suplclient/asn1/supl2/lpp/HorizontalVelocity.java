...
* 
*/
public  class HorizontalVelocity extends Asn1Sequence {
  //

  private static final Asn1Tag TAG_HorizontalVelocity
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_HorizontalVelocity != null) {
      return ImmutableList.of(TAG_HorizontalVelocity);
    } else {
  ...
  /**
   * Creates a new HorizontalVelocity from encoded stream.
   */
  public static HorizontalVelocity fromPerUnaligned(byte[] encodedBytes) {
    HorizontalVelocity result = new HorizontalVelocity();
   ...
   * Creates a new HorizontalVelocity from encoded stream.
   */
  public static HorizontalVelocity fromPerAligned(byte[] encodedBytes) {
    HorizontalVelocity result = new HorizontalVelocity();
  ...
  private HorizontalVelocity.bearingType bearing_;
  public HorizontalVelocity.bearingType getBearing() {
    return bearing_;
  }
  /**
   * @throws ClassCastException if value is not a HorizontalVelocity.bearingType
   */
  public void setBearing(Asn1Object value) {
    this.bearing_ = (HorizontalVelocity.bearingType) value;
  }
  public HorizontalVelocity.bearingType setBearingToNewInstance() {
    bearing_ = new HorizontalVelocity.bearingType();
    return bearing_;
  }
  
  private HorizontalVelocity.horizontalSpeedType horizontalSpeed_;
  public HorizontalVelocity.horizontalSpeedType getHorizontalSpeed() {
    return horizontalSpeed_;
  }
  /**
   * @throws ClassCastException if value is not a HorizontalVelocity.horizontalSpeedType
   */
  public void setHorizontalSpeed(Asn1Object value) {
    this.horizontalSpeed_ = (HorizontalVelocity.horizontalSpeedType) value;
  }
  public HorizontalVelocity.horizontalSpeedType setHorizontalSpeedToNewInstance() {
    horizontalSpeed_ = new HorizontalVelocity.horizontalSpeedType();
    return horizontalSpeed_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? HorizontalVelocity.bearingType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? HorizontalVelocity.horizontalSpeedType.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
public static class horizontalSpeedType extends Asn1Integer {
  ...
  public String toIndentedString(String indent) {
    ...
    builder.append("HorizontalVelocity = {\n");
