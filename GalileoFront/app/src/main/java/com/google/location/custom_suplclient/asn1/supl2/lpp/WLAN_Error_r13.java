 ...
 * 
 */
public  class WLAN_Error_r13 extends Asn1Choice {
  //

  private static final Asn1Tag TAG_WLAN_Error_r13
      ...
      for (Asn1Tag tag : select.getPossibleFirstTags()) {
        ...
        if ((select0 = tagToSelection.put(tag, select)) != null) {
          throw new IllegalStateException(
            "WLAN_Error_r13: " + tag + " maps to both " + select0 + " and " + select);
        }
      }
    }
  }

  public WLAN_Error_r13() {
    super();
  }
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_WLAN_Error_r13 != null) {
      return ImmutableList.of(TAG_WLAN_Error_r13);
    } else {
  ...
  /**
   * Creates a new WLAN_Error_r13 from encoded stream.
   */
  public static WLAN_Error_r13 fromPerUnaligned(byte[] encodedBytes) {
    WLAN_Error_r13 result = new WLAN_Error_r13();
   ...
   * Creates a new WLAN_Error_r13 from encoded stream.
   */
  public static WLAN_Error_r13 fromPerAligned(byte[] encodedBytes) {
    WLAN_Error_r13 result = new WLAN_Error_r13();
  ...
  private static enum Select implements ChoiceComponent {
    ...
    $LocationServerErrorCauses_r13(Asn1Tag.fromClassAndNumber(2, 0),
      ...
      public Asn1Object createElement() {
        return new WLAN_LocationServerErrorCauses_r13();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? WLAN_LocationServerErrorCauses_r13.getPossibleFirstTags() : ImmutableList.of(tag);
      }
    ...
    $TargetDeviceErrorCauses_r13(Asn1Tag.fromClassAndNumber(2, 1),
      ...
      @Override
      public Asn1Object createElement() {
        return new WLAN_TargetDeviceErrorCauses_r13();
      }

      @Override
      Collection<Asn1Tag> getPossibleFirstTags() {
        return tag == null ? WLAN_TargetDeviceErrorCauses_r13.getPossibleFirstTags() : ImmutableList.of(tag);
      }
  ...
  public WLAN_LocationServerErrorCauses_r13 getLocationServerErrorCauses_r13() {
    if (!isLocationServerErrorCauses_r13()) {
      throw new IllegalStateException("WLAN_Error_r13 value not a LocationServerErrorCauses_r13");
    }
    return (WLAN_LocationServerErrorCauses_r13) element;
  }

  public void setLocationServerErrorCauses_r13(WLAN_LocationServerErrorCauses_r13 selected) {
    selection = Select.$LocationServerErrorCauses_r13;
    extension = false;
    element = selected;
  }

  public WLAN_LocationServerErrorCauses_r13 setLocationServerErrorCauses_r13ToNewInstance() {
      WLAN_LocationServerErrorCauses_r13 element = new WLAN_LocationServerErrorCauses_r13();
   ...
   */
  @SuppressWarnings("unchecked")
  public WLAN_TargetDeviceErrorCauses_r13 getTargetDeviceErrorCauses_r13() {
    if (!isTargetDeviceErrorCauses_r13()) {
      throw new IllegalStateException("WLAN_Error_r13 value not a TargetDeviceErrorCauses_r13");
    }
    return (WLAN_TargetDeviceErrorCauses_r13) element;
  }

  public void setTargetDeviceErrorCauses_r13(WLAN_TargetDeviceErrorCauses_r13 selected) {
    selection = Select.$TargetDeviceErrorCauses_r13;
    extension = false;
    element = selected;
  }

  public WLAN_TargetDeviceErrorCauses_r13 setTargetDeviceErrorCauses_r13ToNewInstance() {
      WLAN_TargetDeviceErrorCauses_r13 element = new WLAN_TargetDeviceErrorCauses_r13();
  ...
  public String toIndentedString(String indent) {
    return "WLAN_Error_r13 = " + elementIndentedString(indent) + indent + ";\n";
  }
}
