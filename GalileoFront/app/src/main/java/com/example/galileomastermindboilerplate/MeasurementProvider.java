...
//              }
                ...
                public void onLocationChanged(Location location) {
                    GeneralStatsPage.Latitude = location.getLatitude();
                    GeneralStatsPage.Longitude = location.getLongitude();
                    GeneralStatsPage.Altitude = location.getAltitude();
                    GeneralStatsPage.Accuracy = location.getAccuracy();
                    GeneralStatsPage.Bearing = location.getBearing();
                    GeneralStatsPage.BearingAccuracy = location.getBearingAccuracyDegrees();
